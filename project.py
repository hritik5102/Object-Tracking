...
cap=cv2.VideoCapture('object1.mp4')

cv2.namedWindow('tb')
cv2.createTrackbar('lh','tb',161,180,nothing)
cv2.createTrackbar('uh','tb',180,180,nothing)
cv2.createTrackbar('ls','tb',56,255,nothing)
cv2.createTrackbar('us','tb',116,255,nothing)
cv2.createTrackbar('lv','tb',131,255,nothing)
cv2.createTrackbar('uv','tb',231,255,nothing)
